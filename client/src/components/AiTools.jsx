...
import { useUser } from '@clerk/clerk-react'; // Assuming you are using Clerk for user management
    ...
    return (
        <div className='px-4 sm:px-20 xl:px-32 my-24'>
            <div className="text-center">
                ...
                <p className='text-gray-500 max-w-lg mx-auto'>Everything you need to create, enhance, and optimize content with cutting-edge AI technology.</p>
            </div>
